...
The lineage is MANET and swarm robotics (decentralized, no required infrastructure, no central ground), but Murmur is a contract layer above the network, not a routing protocol.
